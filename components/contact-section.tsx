                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full pl-12 pr-4 py-3 glass rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-electric/50 transition-all"
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      required
                      rows={4}
                      className="w-full pl-12 pr-4 py-3 glass rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-electric/50 transition-all resize-none"
